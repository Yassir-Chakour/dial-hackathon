"""Pytest configuration and fixtures for testing the backend foundation."""
...
def app(test_settings: Settings):
    """Create FastAPI application with test settings and probe routes."""
    application = build_app(settings=test_settings)
